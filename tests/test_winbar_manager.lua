...
T["add_to_unique_list"] = function()
	...
	eq(manager.unique_name_manager["buz.txt"], {
		[1] = {
			path_segment = { "", "home", "adam", "foo", "bar", "buz.txt" },
			buffer_name = "buz.txt",
		},
	})
	eq(manager.unique_name_manager["piyo.txt"], {
		[2] = {
...
T["get_unique_name"] = function()
	...
	manager:add_to_unique_list(2, "/home/adam/foo/bar/piyo.txt")
	manager:add_to_unique_list(3, "/home/adam/foo/bar2/piyo.txt")
	eq(manager.unique_name_manager["buz.txt"][1].buffer_name, "buz.txt")
	eq(manager.unique_name_manager["piyo.txt"][2].buffer_name, "bar/piyo.txt")
	eq(manager.unique_name_manager["piyo.txt"][3].buffer_name, "bar2/piyo.txt")
end
...
T["delete_from_unique_list"] = function()
	...
	manager:add_to_unique_list(1, "/home/adam/foo/bar/buz.txt")
	manager:add_to_unique_list(2, "/home/adam/foo/bar/piyo.txt")
	eq(manager.unique_name_manager["piyo.txt"][2].buffer_name, "piyo.txt")
	...
	eq(manager.unique_name_manager["buz.txt"][1].buffer_name, "buz.txt")
	eq(manager.unique_name_manager["piyo.txt"][2].buffer_name, "piyo.txt")
	eq(manager.unique_name_manager["piyo.txt"][3], nil)
	eq(vim.fn.len(vim.fn.filter(manager.unique_name_manager["piyo.txt"], "v:val isnot v:null")), 1)
end
